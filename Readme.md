...
Package files:
- `Brewfile` - Core packages required for deployment and a working terminal (stow, git, gh, neovim, tmux, mise, fzf, ripgrep, bat, zoxide, starship, ghostty, libyaml) — see `Brewfile` for the full list
